...
- nome: nome do recebedor (completo se possível)
- valor: valor da transação em float (ex: 15.00)
- chave_pix: a chave PIX usada (pode incluir +55 no início, normalize removendo caracteres especiais)
- data: data da transação em formato DD/MM/YYYY
